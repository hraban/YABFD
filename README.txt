...
==Installation==
  ...
  * * * * * crc=`cksum /etc/hosts.deny.yabfd` ; /usr/local/yabfd/yabfd ; sort -n -t . -k 1 -k 2 -k 3 -k 4 -o /etc/hosts.deny.yabfd /etc/hosts.deny.yabfd ; if [ "$crc" != "$(cksum /etc/hosts.deny.yabfd)" ] ; then /etc/init.d/squid reload ; fi
